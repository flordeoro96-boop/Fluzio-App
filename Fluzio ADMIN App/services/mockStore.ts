...
class MockStore {
  ...
  createUserFromFirebase(firebaseProfile: any): User {
    ...
    const role = firebaseProfile.role === 'BUSINESS' ? 'BUSINESS' : 'CREATOR';
    const creatorMode = firebaseProfile.creatorMode !== undefined 
      ? firebaseProfile.creatorMode 
      : firebaseProfile.role === 'CREATOR';
