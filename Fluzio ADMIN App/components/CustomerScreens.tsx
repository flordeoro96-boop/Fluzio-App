...
const StoryRing: React.FC<{ img: string, name: string, seen?: boolean }> = ({ img, name, seen }) => (
    <div className="flex flex-col items-center space-y-1 cursor-pointer active:scale-95 transition-transform">
        <div className={`p-[3px] rounded-full ${seen ? 'bg-gray-200' : 'bg-gradient-to-tr from-[#FFC300] via-[#F72585] to-[#7209B7]'}`}>
        ...
        <div className="pb-24">
            ...
            <div className="pt-12 px-6 pb-4 bg-white/50 backdrop-blur-sm sticky top-0 z-30">
                <div className="flex items-center justify-between">
                    ...
                    >
                        <SlidersHorizontal className="w-5 h-5 text-[#7209B7]" />
                        {activeFilterCount > 0 && (
                            <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#F72585] text-white text-xs font-bold rounded-full flex items-center justify-center">
                                {activeFilterCount}
                            </span>
                        )}
                    </button>
                    ...
                    <div className="space-y-4">
                        ...
                        {activeFilterCount > 0 && (
                            <button
                                ...
                                className="w-full py-2 text-sm font-bold text-[#F72585] hover:text-[#7209B7] transition-colors"
                            >
            ...
            {loading && (
                <div className="flex items-center justify-center py-20">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#F72585]"></div>
                </div>
            )}
                    ...
                    <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-500">
                        <div className="grid grid-cols-2 gap-3">
                            <StatCard 
                                ...
                                color="bg-gradient-to-br from-[#F72585] to-[#7209B7]"
                            />
                            <StatCard 
                                icon={TrendingUp}
                                label={t('community.totalPoints')}
                                value={stats.totalEarnings.toString()}
                                color="bg-gradient-to-br from-[#FFC300] to-[#FF8C00]"
                            />
                            <StatCard 
                                icon={Users}
                        ...
                        <Card className="p-5">
                            ...
                            <div className="space-y-3">
                                <button className="w-full flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                    <div className="w-10 h-10 bg-[#F72585]/10 rounded-lg flex items-center justify-center">
                                        <Map className="w-5 h-5 text-[#F72585]" />
                                    </div>
                                ...
                                <button className="w-full flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                    <div className="w-10 h-10 bg-[#7209B7]/10 rounded-lg flex items-center justify-center">
