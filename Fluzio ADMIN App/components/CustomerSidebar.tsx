...
export const CustomerSidebar: React.FC<CustomerSidebarProps> = ({
  ...
  const displayPlanTier = currentUser?.subscriptionLevel || user.subscriptionLevel || 'SILVER';
      ...
      <div className="relative w-80 bg-[#F8F9FE] h-full shadow-2xl transform transition-transform duration-300 flex flex-col animate-in slide-in-from-left rounded-r-[32px] overflow-hidden">
        ...
        <div className="p-8 bg-white relative">
            ...
            <div className="flex flex-col items-center text-center">
                <div className="p-[3px] bg-gradient-to-br from-[#FFC300] via-[#F72585] to-[#7209B7] rounded-full mb-4 shadow-lg shadow-[#F72585]/20">
                    <img 
                        src={displayPhoto} 
                        alt={displayName} 
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                    {/* Plan Tier Badge */}
                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#FFC300]/10 border border-[#FFC300]/50 text-[#d9a500] text-xs font-bold">
                ...
                {/* Credits Display */}
                <div className="mt-4 w-full bg-gradient-to-r from-[#FFC300]/10 to-[#F72585]/10 p-3 rounded-2xl border border-[#FFC300]/30">
                    <div className="flex items-center justify-center gap-2">
                        <Wallet className="w-4 h-4 text-[#F72585]" />
        ...
        <div className="flex-1 overflow-y-auto py-4 px-4 space-y-3">
            ...
            <button className="w-full bg-white p-4 rounded-2xl border border-white shadow-sm hover:shadow-md transition-all flex items-center gap-4 group">
                <div className="w-10 h-10 rounded-full bg-pink-50 text-[#F72585] flex items-center justify-center group-hover:bg-[#F72585] group-hover:text-white transition-colors">
            ...
            <button className="w-full bg-gradient-to-r from-[#FFC300]/20 to-[#F72585]/10 p-4 rounded-2xl border border-[#FFC300]/30 shadow-[0_4px_15px_rgba(255,195,0,0.2)] hover:shadow-[0_4px_20px_rgba(255,195,0,0.4)] transition-all flex items-center gap-4 group relative overflow-hidden">
                <div className="absolute inset-0 bg-white/40 backdrop-blur-[1px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FFC300] to-orange-400 text-white flex items-center justify-center relative z-10 shadow-lg shadow-orange-300/50">
                    <Plane className="w-5 h-5" />
                </div>
                <div className="text-left flex-1 relative z-10">
                    <div className="font-clash font-bold text-[#1E0E62] text-sm flex items-center gap-1">
                        {t('sidebar.jetsetterPass', 'Jetsetter Pass')} <span className="text-[10px] bg-[#FFC300] text-[#1E0E62] px-1.5 rounded font-black">PRO</span>
                    </div>
        ...
        <div className="p-6 bg-white border-t border-gray-100">
             ...
             <div className="space-y-2 mb-4">
                ...
                <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
                    <Eye className="w-5 h-5 text-gray-500 group-hover:text-[#F72585]" />
                ...
                {/* Settings */}
                <button onClick={onOpenSettings} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
                    <Settings className="w-5 h-5 text-gray-500 group-hover:text-[#F72585]" />
                    <span className="text-sm font-medium text-gray-700 group-hover:text-[#1E0E62]">
                ...
                {/* Help */}
                <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
                    <HelpCircle className="w-5 h-5 text-gray-500 group-hover:text-[#F72585]" />
                    <span className="text-sm font-medium text-gray-700 group-hover:text-[#1E0E62]">
                        {t('settings.help')}
                    </span>
                </button>
                ...
                {/* Logout */}
                <button onClick={onLogout} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
             ...
             <div className="flex items-center justify-between text-xs text-gray-400">
                ...
                <div className="flex gap-2">
                    <button className="hover:text-[#F72585]">Privacy</button>
                    <span>·</span>
                    <button className="hover:text-[#F72585]">Terms</button>
                </div>
             </div>
        </div>
      </div>
