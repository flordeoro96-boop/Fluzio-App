        ...
        <div className="bg-white/80 backdrop-blur-xl border border-white/50 rounded-[32px] shadow-[0_20px_40px_rgba(114,9,183,0.1)] h-[72px] flex items-center justify-around px-2 relative overflow-hidden">
           ...
           {tabs.map(tab => {
             ...
             return (
               ...
               >
                 <div className={`mb-1 transition-all duration-300 p-2 rounded-full ${isActive ? 'bg-gradient-to-tr from-[#FFB86C] via-[#00E5FF] to-[#6C4BFF] text-white shadow-lg shadow-[#00E5FF]/30' : 'text-[#8F8FA3] group-hover:bg-gray-50'}`}>
