...
export const DailyXPClaimModal: React.FC<DailyXPClaimModalProps> = ({
  ...
  useEffect(() => {
    ...
    } else if (canClaim && !claimed && !claiming) {
      // Auto-claim XP when modal opens
      handleClaim();
    }
  }, [isOpen]);
          ...
          <div className="p-8 text-center text-white relative z-10">
            {!claimed ? (
              <>
                ...
                {/* Auto-claiming Message */}
                <div className="w-full py-5 rounded-2xl font-black text-xl bg-white/20 text-white flex items-center justify-center gap-2">
                  {claiming ? (
                    <>
