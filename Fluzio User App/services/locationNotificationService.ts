    ...
    for (const business of favoriteBusinesses) {
      ...
      if (distance <= prefs.locationBased.radius) {
        ...
        await createNotification(
          ...
          {
            type: 'SYSTEM',
            title: `You're near ${business.businessName}!`,
            message: `You're ${Math.round(distance)}m away. Check out their active missions and rewards!`,
            actionLink: `/business/${business.businessId}`,
          },
          'missions'
        );
